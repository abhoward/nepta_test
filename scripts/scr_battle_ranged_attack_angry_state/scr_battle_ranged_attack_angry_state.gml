///scr_battle_ranged_attack_angry_state(xoffset, yoffset, effect, effect_frame)
...
// Set the sprite
scr_battle_set_sprite(RANGED_ANGRY, 0);

var targetx = xstart + BATTLE_SPACE * image_xscale;
var sprite_data = o_data.sprites[? sprite_get_name(sprite[RANGED_ANGRY])];
