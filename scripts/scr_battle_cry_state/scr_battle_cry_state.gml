...
global.player_poison_pos = random_range(0, o_player_battle_unit.max_action_meter);
global.enemy_poison_pos = random_range(0, o_enemy_battle_unit.max_action_meter);