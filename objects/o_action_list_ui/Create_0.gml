...
if (o_stance_action_list_ui.stance_name == "Sad Actions") {
...
} else if (o_stance_action_list_ui.stance_name == "Angry Actions") {
...
} else if (o_stance_action_list_ui.stance_name == "Content Actions") {
