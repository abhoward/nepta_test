...
switch (action) {
	...
	case 5: create_textevent(["You realize what could happen, right? What the consequences are?", "I know. I don't care.", "Even if it means losing your memories forever?", "...yes."], -1,-1,-1,-1,-1,-1,-1,-1,-1); break;
