...
switch (action) {
	...
	case 24: scr_character_move_to([o_art], [-116], [0], [true], [4.5], false, 0); break;
	case 25: scr_character_move_to([o_art], [0], [100], [true], [4.5], false, 0); break;
	case 26: scr_cutscene_play_audio([a_electric_door], [0]); break;
	case 27: scr_cutscene_destroy_object([o_art], [0.025], [0]); break;
	case 28: create_dialogue(["Guess I don't have much of a choice..."], o_jane, -1, -1, 0, -1, -1, -1, [PORTRAIT_ANNOYED], -1); break;
	case 29: instance_destroy(); break;
