...
#region TYPE 0: NORMAL DIALOGUE
	...
	repeat(charCount){
		...
		switch(effect){
			...
			case 1:	//shakey
				draw_text_color(xx + random_range(-1,1), yy+(cy*stringHeight)+random_range(-1,1), letter, col, col, col, col, 1);
				xx = xx + string_width(letter);
				break;
			...
			case 2:	//wave
				...
				draw_text_color(xx, yy+(cy*stringHeight)+shift, letter, col, col, col, col, 1);
				xx = xx + string_width(letter);
				break; 
			...
			case 3: //colour shift
				...
				draw_text_color(xx, yy+(cy*stringHeight), letter, c1, c1, c2, c2, 1);
				xx = xx + string_width(letter);
				break;
			...
			case 4: //wave AND colour shift
				...
				draw_text_color(xx, yy+(cy*stringHeight)+shift, letter, c1, c1, c2, c2, 1);
				xx = xx + string_width(letter);
				break; 
			...
			case 5: //spin
				...
				draw_text_transformed_color(xx + mv, yy+(cy*stringHeight)+(stringHeight/2), letter, 1, 1, shift*20, col, col, col, col, 1);
				xx = xx + string_width(letter);
			...
			case 6: //pulse
				...
				var mv = charSize/2;
				draw_set_valign(fa_middle); draw_set_halign(fa_middle);
				draw_text_transformed_color(xx + mv, yy+(cy*stringHeight)+(stringHeight/2), letter, shift, shift, 0, col, col, col, col, 1);
				xx = xx + string_width(letter);
				draw_set_valign(fa_top); draw_set_halign(fa_left);
				break;
