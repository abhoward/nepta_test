...
switch (action) {
	...
	case 5: scr_character_show_dialog(o_jane, array("I'm sorry, what? Arrived from the heavens?", "What's exactly going on? And why can't I remember anything?")); break;
