...
switch (action) {
    case 0: scr_character_move_to(o_elizabeth, 42, 0, true, o_elizabeth.spd, 0); break;
	case 1: scr_character_face_direction(o_elizabeth, UP, .5); break;
    ...
    case 3: scr_character_show_dialog(o_elizabeth, array("...partying? I, uh, don't know what you're talking about.")); break;
	...
	case 5: scr_character_show_dialog(o_elizabeth, array("Oh. Right. Sorry.", "But I wasn't partying. I was having sex.")); break;
